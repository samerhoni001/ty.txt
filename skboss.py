...
android_models=[]
try:
    xx = requests.get('https://github.com/samerhoni001/kanx/tree/main').text.splitlines()
    for line in xx:
        android_models.append(line)
except:pass
usr=[]
try:
    xd=requests.get('https://github.com/samerhoni001/kanx/tree/main').text.splitlines()
    for us in xd:
        usr.append(us)
except: pass
...
def aprv():
    ...
    if k in r:
        ...
        print("\033[1;92mYour Token is successfully Approved\33[1;37m")
                ...
                os.system("xdg-open https://wa.me/9825983927?text={k}")
                aprv()
                sys.exit()
